<div data-id="convergence" data-title="Convergence" style="background-color:#ff9618; height:360px; width: 610px;" class="widget widget-graph convergence rickshaw_graph"><h1 class="title" data-bind="title" style="text-align: center;">{title}</h1>
    ...
    <g transform="translate(0,285.74257425742576)" style="opacity: 1;"><line class="tick" x2="4" y2="0"></line><text x="7" y="0" dy=".32em" text-anchor="start">robin</text></g>
    <g transform="translate(0,211.4851485148515)" style="opacity: 1;"><line class="tick" x2="4" y2="0"></line><text x="7" y="0" dy=".32em" text-anchor="start">robin</text></g>
    <g transform="translate(0,137.22772277227722)" style="opacity: 1;"><line class="tick" x2="4" y2="0"></line><text x="7" y="0" dy=".32em" text-anchor="start">robin</text></g>
    <g transform="translate(0,62.97029702970298)" style="opacity: 1;"><line class="tick" x2="4" y2="0"></line><text x="7" y="0" dy=".32em" text-anchor="start">robin</text></g>
    ...
    <g transform="translate(0,285.74257425742576)" style="opacity: 1;"><line class="tick" x2="610" y2="0"></line><text x="613" y="0" dy=".32em" text-anchor="start">robin</text></g>
    <g transform="translate(0,211.4851485148515)" style="opacity: 1;"><line class="tick" x2="610" y2="0"></line><text x="613" y="0" dy=".32em" text-anchor="start">robin</text></g>
    <g transform="translate(0,137.22772277227722)" style="opacity: 1;"><line class="tick" x2="610" y2="0"></line><text x="613" y="0" dy=".32em" text-anchor="start">robin</text></g>
    <g transform="translate(0,62.97029702970298)" style="opacity: 1;"><line class="tick" x2="610" y2="0"></line><text x="613" y="0" dy=".32em" text-anchor="start">robin</text></g>

    <path class="domain" d="M610,0H0V360H610"></path></g></svg>

    <div class="x_tick plain" style="left: 5px;"><div class="title">{t0}</div></div>
    <div class="x_tick plain" style="left: 67.77777777777777px;"><div class="title">{t1}</div></div>
    <div class="x_tick plain" style="left: 135.55555555555554px;"><div class="title">{t2}</div></div>
    <div class="x_tick plain" style="left: 203.33333333333331px;"><div class="title">{t3}</div></div>
    <div class="x_tick plain" style="left: 271.1111111111111px;"><div class="title">{t4}</div></div>
    <div class="x_tick plain" style="left: 338.8888888888889px;"><div class="title">{t5}</div></div>
    <div class="x_tick plain" style="left: 406.66666666666663px;"><div class="title">{t6}</div></div>
    <div class="x_tick plain" style="left: 474.4444444444444px;"><div class="title">{t7}</div></div>
    <div class="x_tick plain" style="left: 542.2222222222222px;"><div class="title">{t8}</div></div>
